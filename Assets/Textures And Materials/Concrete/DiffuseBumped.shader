Shader "TriProj-DiffuseBumped" {
	...
	SubShader {
		...
		fixed4 _Color;
		sampler2D _MainTex, _BumpMap, _DetailTex;
		float4 _MainTex_ST, _BumpMap_ST, _DetailTex_ST;
		fixed _Blend;
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			o.Albedo = lerp(col.rgb, det.rgb, _Blend) * unity_ColorSpaceDouble.r;
